...
interface org.weemvc.as2.model.IModelLocator {
	 ...
	 * 获得指定的模型类。
	 * 
	 * @param	modelName	指定要获得的模型类名，都要实现<code>IModel</code>接口
	 ...
	 * 添加模型类。
	 * 
	 * @param	modelName	指定要添加的模型类名，都要实现<code>IModel</code>接口
	 ...
	 * 移除模型类。
	 * 
	 * @param	modelName	指定要移除的模型类名，都要实现<code>IModel</code>接口
	 */
	function removeModel(modelName:String):Void;
	/**
	 * 判断指定的模型类是否存在。
	 * 
	 * @param	modelName	指定的模型类名，都要实现<code>IModel</code>接口
	 * @return	是否存在
	 */
